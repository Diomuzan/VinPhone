...
return [
    ...
    'news_edit' => [['id'], ['_controller' => 'App\\Controller\\NewsController::edit'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/news/edit']], [], [], []],
    ...
    'App\Controller\NewsController::index' => [[], ['_controller' => 'App\\Controller\\NewsController::index'], [], [['text', '/news']], [], [], []],
    'App\Controller\NewsController::new' => [[], ['_controller' => 'App\\Controller\\NewsController::new'], [], [['text', '/news/new']], [], [], []],
    'App\Controller\NewsController::show' => [['id'], ['_controller' => 'App\\Controller\\NewsController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/news/detail']], [], [], []],
    'App\Controller\NewsController::edit' => [['id'], ['_controller' => 'App\\Controller\\NewsController::edit'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/news/edit']], [], [], []],
